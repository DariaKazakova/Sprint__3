...
class main_page_locators:
    ...
    sauces_button = (By.XPATH, './/main/section[1]/div[1]/div[2]') #Кнопка соусы
    ...
    insides_button = (By.XPATH, './/main/section[1]/div[1]/div[3]') #Кнопка начинки
...
class registration_page_locators:
    ...
    email_input_re = (By.XPATH, './/fieldset[2]//input') #Инпут ввода емэйла в форме регистрации
    password_input_re = (By.XPATH, './/fieldset[3]//input') #Инпут ввода пароля в форме регистрации
...
class log_in_locators:
    ...
    email_input_lo = (By.XPATH, './/fieldset[1]/div/div/input') #Инпут ввода email'a в разделе логина
    password_input_lo = (By.XPATH, './/fieldset[2]/div/div/input') #Инпут ввода пароля в разделе логина
